...
3. Intro
4. Choose Role
5. Recipient or Volunteer path

Volunteer mode is a separate hub (delivery, dispatcher, kitchen). If onboarding is complete, the app loads directly into the selected path.
